...
# Load trajectories
# =========================
traj_10 = np.load("fish_trajectory_i1.0.npy")  # Not used in final drawing, but loaded for completeness
traj_15 = np.load("fish_trajectory_i1.5.npy")
traj_20 = np.load("fish_trajectory_i2.0.npy")
traj_25 = np.load("fish_trajectory_i2.5.npy")
