...
if __name__ == '__main__':
    try:
        ...
        # calibration_data = np.load('/home/kloya/catkin_fishcam_ws/src/fish_pc/scripts/camera_calibration_data.npz')
        ...
        file_path = "/home/kloya/catkin_fishcam_ws/src/fish_pc/scripts/Camera_Calibrate_runcam/fisheye_calibration_22.pkl"
        ...
        if ret:
            ...
            cv2.line(undistorted_frame, (CS[0], 0), (CS[0], h), [0,0,0], 2)
            cv2.line(undistorted_frame, (0, CS[1]), (w, CS[1]), [0,0,0], 2)
